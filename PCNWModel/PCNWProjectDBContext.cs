...
public partial class PCNWProjectDBContext : DbContext
{
    ...
    public virtual DbSet<ArchOwner> ArchOwners { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<ArchOwner>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK_tblArchOwner");

            entity.ToTable("ArchOwner");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK_tblContractor");
            ...
            entity.Property(e => e.Pwd)
                ...
                .HasColumnName("PWD");
            entity.Property(e => e.State).HasMaxLength(50);
            entity.Property(e => e.SyncArchId).HasColumnName("SyncArchID");
            entity.Property(e => e.SyncStatus).HasDefaultValueSql("((1))");
            entity.Property(e => e.Uid)
                .HasMaxLength(20)
                .HasColumnName("UID");
        ...
        modelBuilder.Entity<Entity>(entity =>
        {
            ...
            entity.Property(e => e.BusinessEntityId).HasDefaultValueSql("((1))");
            entity.Property(e => e.ChkIssue).HasColumnName("chkIssue");
            entity.Property(e => e.CompType).HasDefaultValueSql("((1))");
            ...
            entity.HasOne(d => d.BusinessEntity).WithMany(p => p.Entities)
                .HasForeignKey(d => d.BusinessEntityId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Entity__Business__2FAFEA50");
        });
        ...
        modelBuilder.Entity<Project>(entity =>
        {
            ...
            entity.Property(e => e.AddendaNote).HasMaxLength(100);
            ...
            entity.Property(e => e.PrebidNote).HasMaxLength(100);
